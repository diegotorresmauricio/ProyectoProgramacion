...
public:
	...
	void editarRepuesto(String^, String^, String^);
//	void eliminarRepuesto(String^, String^, String^);
	void insertarPresupuesto(String^ idCli, String^ idRep, String^ mdo, String^ total);
	void editarPresupuesto(String^ idCli, String^ idRep, String^ mdo, String^ total);
//	void eliminarPresupuesto(String^ idCli, String^ idRep, String^ mdo, String^ total);
	void insertarConocimiento(String^, String^);
	void editarConocimiento(String^, String^);
//	void eliminarConocimiento(String^, String^);
};
